...
public class DBScanLinear {
    ...
    public DBScanLinear(List<Point3D> DB){
        this.DB = DB;
	...
	*/
    public void save(String filename) throws FileNotFoundException, UnsupportedEncodingException{
        ...
        PrintWriter writer = new PrintWriter("Linear "+filename, "UTF-8");
...
//    public static void runDBScanLinear(String fileName, String eps, String minPts) throws FileNotFoundException, UnsupportedEncodingException {
//        long startTime = System.currentTimeMillis();
//        String[] params = new String[] {"Point_cloud_2.csv","1.2","10"};
//        for(int i=0;i<3;i++){params[i]=args[i];}
//        List<Point3D> DB = read(fileName);
//        //No file name means no runtime
//        DBScanLinear dbs = new DBScanLinear(DB);
//        //setting epsilon
//        dbs.setEps(Double.parseDouble(eps));
//        //setting minpts
//        dbs.setMinPts(Integer.parseInt(minPts));
//        //get the clusters
//        dbs.findClusters();
//        dbs.displayClusters();
//        //save the output
//        dbs.save(fileName.split("\\.")[0]+"_clusters_"+dbs.getEps()+"_"+dbs.getMinPts()+"_"+dbs.getNumberOfClusters()+".csv");
